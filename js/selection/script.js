...
function randomInput() {
  ...
  if (numRandom.match(/^[0-9\s]*$/)) {
    ...
    document.getElementById("selection-sort__random__data").innerText =
      "Invalid input";
  }
}
...
function userInput() {
  clearError();
  var userValues = document.getElementById("selection-sort__data__user").value;
  ...
  if (userValues.match(/^[0-9,\s]*$/)) {
    ...
    document.getElementById("selection-sort__user__data").innerText =
      "Invalid input";
  }
}
