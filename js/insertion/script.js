...
function randomInput() {
  ...
  if (numRandom.match(/^[0-9\s]*$/)) {
    ...
    document.getElementById("insertion-sort__random__data").innerText =
      "Invalid input";
  }
}
...
function userInput() {
  clearError();
  var userValues = document.getElementById("insertion-sort__data__user").value;
  ...
  if (userValues.match(/^[0-9,\s]*$/)) {
    ...
    document.getElementById("insertion-sort__user__data").innerText =
      "Invalid input";
  }
}
